import unittest
from ResNet182DD.assets.layers.conv2d_layer import Conv2DLayer
...
class TestConv2DLayer(unittest.TestCase):
    ...
    def test_filters_wrong__value_value__error(self):
        ...
        with self.assertRaises(ValueError):
            Conv2DLayer(filters=filters, kernel_size=(1, 1), strides=(1, 1), 
                        padding="same")
    ...
    def test_kernel__size_wrong__value_value__error(self):
        ...
        # Act and Assert
        with self.assertRaises(ValueError):
            Conv2DLayer(filters=1, kernel_size=kernel_size, strides=(1, 1), 
                        padding="same")
    ...
    def test_strides_wrong__value_value__error(self):
        ...
        # Act and Assert
        with self.assertRaises(ValueError):
            Conv2DLayer(filters=1, kernel_size=(1, 1), strides=strides, 
                        padding="same")
    ...
    def test_padding_wrong__value_value__error(self):
        ...
        # Act and Assert
        with self.assertRaises(ValueError):
            Conv2DLayer(filters=1, kernel_size=(1, 1), strides=(1, 1), 
                        padding=padding)
    ...
    def test_creation_init_layer(self):
        ...
        # Arrange and Act
        layer = Conv2DLayer(filters=1, kernel_size=(1, 1), strides=(1, 1), 
                            padding="same")
    ...
    def test_output_tensor_intended__shape(self):
        ...
        # Arrange
        input_tensor = tf.random.normal((1, 1, 1, 3))

        # Act
        output = Conv2DLayer(filters=1, kernel_size=(1, 1), strides=(1, 1), 
    ...
    def test_get__config_init_matching__dict(self):
        ...
        init_params = [
            param.name
            for param in inspect.signature(Conv2DLayer.__init__).parameters.values()
