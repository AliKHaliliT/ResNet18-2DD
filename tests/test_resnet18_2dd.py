import unittest
from ResNet182DD.resnet18_2dd import ResNet182DD
import tensorflow as tf
import inspect


class TestResNet182DD(unittest.TestCase):
    ...
    def test_compute__output__shape_shape_intended__shape(self):
        ...
        # Arrange
        model = ResNet182DD()
        input_tensor = tf.random.uniform((1, 32, 32, 3))
    ...
    def test_get__config_init_matching__dict(self):
        ...
        init_params = [
            param.name
            for param in inspect.signature(ResNet182DD.__init__).parameters.values()
    ...
    def test_from__config_config__dict_inputted__config__dict(self):
        ...
        # Act
        cloned = ResNet182DD.from_config(model.get_config())
